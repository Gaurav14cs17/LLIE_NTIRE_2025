...
import glob
from train.models.archs_utils import define_network
from train.models.base_model import BaseModel
from train.utils import get_root_logger, imwrite, tensor2img
...
class ImageCleanModel(BaseModel):
    ...
    def init_training_settings(self):
        ...
        if train_opt.get('pixel_opt'):
            ...
            self.cri_pix = cri_pix_cls(**train_opt['pixel_opt']).to(self.device)      #如何写 weighted loss 呢？传参构造Loss函数
        else:
