...
class CosineAnnealingRestartLR(_LRScheduler):
    ...
    def get_lr(self):
        ...
        return [self.eta_min + current_weight * 0.5 * (base_lr - self.eta_min) *(1 + math.cos(math.pi * ((self.last_epoch - nearest_restart) / current_period)))
...
class CosineAnnealingRestartCyclicLR(_LRScheduler):
    ...
    def get_lr(self):
        ...
        return [eta_min + current_weight * 0.5 * (base_lr - eta_min) *(1 + math.cos(math.pi * (
                (self.last_epoch - nearest_restart) / current_period)))for base_lr in self.base_lrs]
