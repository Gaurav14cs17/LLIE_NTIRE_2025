...
from RetinexMamba_arch_lap import RetinexMamba
from utils import model_opr




model_name = 'refinexmamba_lap'
...
model_path = '/dataset/kunzhou/project/low_light_noisy/logs/mamba_en_py4/mambaretinex_lolv2/models/best_retinex_lolv2_ft.pth'
