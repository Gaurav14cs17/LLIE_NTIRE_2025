...
class Restormer(nn.Module):
    def __init__(self, 
        ...
        self.patch_embed = OverlapPatchEmbed(24, dim)
        ...
        self.output = nn.Conv2d(int(dim*2**1), 12, kernel_size=3, stride=1, padding=1, bias=bias)
    ...
    def forward(self, inp_img,inp_s1_img,gt=None):
        ...
        inp_enc_level1 = self.patch_embed(ins) # torch.cat([inp_img,inp_s1_img],1)
