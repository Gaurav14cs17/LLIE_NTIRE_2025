...
class NYU_v2_datset(tData.Dataset):
    def __init__(self, root_dir = '/dataset/kunzhou/project/low_light_noisy/lol_dataset/LOL-v2',
        ...
        #     hn_root = '/dataset/kunzhou/project/low_light_noisy/exp_decomposition/baseline_star/predict'
        #     print('model type',model_type)
        # hn_root = '/dataset/kunzhou/project/low_light_noisy/exp_decomposition/baseline_star/predict'
        # hn_root = '/dataset/kunzhou/project/low_light_noisy/llie_cvpr24/exp/IAT_GLDEO/predict'
        ...
        if 'train' in self.split:
            ...
            # hn_path = sorted(glob.glob('/dataset/kunzhou/project/low_light_noisy/llie_cvpr24/exp/IAT_GLDEO/predict/Test/*.png')) 
